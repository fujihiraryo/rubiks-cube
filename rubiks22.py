...
class Cube:
    ...
    def show(self):
        ...
        print('{} {} {} {} {} {} {} {}'.format(
            self.l[0], self.l[1], self.f[0], self.f[1], self.r[0], self.r[1], self.b[0], self.b[1]))
        print('{} {} {} {} {} {} {} {}'.format(
            self.l[3], self.l[2], self.f[3], self.f[2], self.r[3], self.r[2], self.b[3], self.b[2]))
    ...
    def shuffle(self, n=10):
        for i in range(n):
            self.rotate(random.choice(['D', 'F', 'R']))
